...
<template>
  <video
    ...
    autoplay
    muted
    class="absolute -z-10 h-[100vh] w-[100vw] object-cover"
  >
    <source src="@/assets/ui/nuke.webm" type="video/webm" />
  </video>
  <div class="flex min-h-screen flex-row">
    <nav
      id="leftnav"
      class="panoramaBlur flex w-[5vw] flex-col justify-between"
    >
      <div class="flex flex-col">
        <RouterLink
          to="/"
          class="panoramaBorder flex h-[5vw] items-center justify-center"
        >
          <img
        ...
        <div
          id="playButtons"
          class="panoramaBorder flex h-[10vw] flex-col items-center justify-evenly"
        >
          <RouterLink to="/play" class="flex">
            <img
    ...
    <aside
      class="panoramaBlur fixed right-[-15vw] top-0 flex h-screen w-[20vw] flex-row transition-all hover:right-0"
    >
      <div class="flex w-[5vw] flex-col items-center">
        <div
          class="panoramaBorder flex h-[11.5vw] w-[5vw] flex-col items-center"
        >
